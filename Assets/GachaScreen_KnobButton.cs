...
public class GachaScreen_KnobButton : GachaScreen_MonoBehaviour {
    [field: Header("Data")]
    [field: SerializeField] public UnityEvent<GachaScreen_KnobButton> OnKnobClicked { get; private set; }
    ...
    private void OnEnable() {
        Button.onClick.AddListener(InvokeOnKnobSpinned);
    }
    private void OnDisable() {
        Button.onClick.RemoveListener(InvokeOnKnobSpinned);
    }
    private void InvokeOnKnobSpinned() {
